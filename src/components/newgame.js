...
class NewGame extends Component {
  ...
  componentDidMount() {
    const gameId = {gameId: this.generateGameId(), status: 'waiting', round: 'Round 1', roundName: 'Taboo', roundDescription: 'During Round 1 you can say anything BUT the word you\'re trying to get your teammates to guess', currentPlayer: '', teamAScore: 0, teamBScore: 0}
